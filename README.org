#+TITLE: Visual Emacs - the sinners editor 😈
#+AUTHOR: Elijah Gabe P.
#+OPTIONS: num:nil

[[./assets/splash.svg]]

#+html: <img src="./assets/README_images/Unsettled-Tom.jpg" align="right" width="25%">
...
#+begin_src elisp
(setq gnus-select-method '(nntp "news.gmane.io") ;; if you read news groups
